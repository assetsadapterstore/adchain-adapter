...
func TestTransfer(t *testing.T) {
	...
	rawTx, err := testCreateTransactionStep(tm, walletID, accountID, to, "1.23", "", "test", &contract)
	if err != nil {
		return
	}
...
func TestSummary(t *testing.T) {
	tm := testInitWalletManager()
	walletID := "W1G6QDzuk1ovBQWV9GzhEzcoicnCyA4uH6"
	accountID := "2ed14xdDvRE1ALxy9HipgdA5asaQPaMN6JgCmGes57XV"
	summaryAddress := "testabcadcha"
